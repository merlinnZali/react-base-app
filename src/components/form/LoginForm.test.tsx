...
// One useful tip is to encapsulate rendering the component you are testing
// using a render helper function so that you can handle props overriding and make your tests more maintainable:
